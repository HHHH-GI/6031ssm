...
public class LvyouxianluController {
    ...
    public R page(@RequestParam Map<String, Object> params,LvyouxianluEntity lvyouxianlu, 
		...
		if(tableName.equals("daoyou")) {
			lvyouxianlu.setDaoyouzhenghao((String)request.getSession().getAttribute("username"));
		}
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("daoyou")) {
			wrapper.eq("daoyouzhenghao", (String)request.getSession().getAttribute("username"));
		}
