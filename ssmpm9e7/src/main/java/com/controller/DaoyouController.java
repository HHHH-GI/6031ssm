...
public class DaoyouController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		DaoyouEntity user = daoyouService.selectOne(new EntityWrapper<DaoyouEntity>().eq("daoyouzhenghao", username));
		if(user==null || !user.getMima().equals(password)) {
			return R.error("账号或密码不正确");
		}
		String token = tokenService.generateToken(user.getId(), username,"daoyou",  "导游" );
    ...
    public R register(@RequestBody DaoyouEntity daoyou){
    	...
    	DaoyouEntity user = daoyouService.selectOne(new EntityWrapper<DaoyouEntity>().eq("daoyouzhenghao", daoyou.getDaoyouzhenghao()));
		if(user!=null) {
    ...
    public R getCurrUser(HttpServletRequest request){
        ...
        DaoyouEntity user = daoyouService.selectById(id);
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<DaoyouEntity> wrapper = new EntityWrapper<DaoyouEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = daoyouService.selectCount(wrapper);
